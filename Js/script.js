...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var formRegistration = document.getElementById('registration-form'),
        contactRegistration = document.getElementById('contact-form'),
    ...
    if (formRegistration) {
        formRegistration.addEventListener('submit', submitRegisterForm, true);
    }
...
// On part du principe qu'il n'y a pas d'erreur d'entrées dans le formulaire, s'il y en a, on utilise la variable error et on incrémente
    ...
    function submitRegisterForm() {
        ...
        if (!isValidEmailAddress(email.value)) {
            ...
            feedback.innerHTML += "Veuillez entrer un email valide<br>";
            error++;
        } else {
        ...
        if (phone.value != '') {
            if (isNaN(phone.value) || phone.value.length < 10) {
                ...
                feedback.innerHTML += "Veuillez entrer un téléphone valide<br>";
                error++;
            } else {
        ...
        if (isNaN(cp.value) || cp.value.length < 5) {
            ...
            feedback.innerHTML += "Veuillez entrer un code postal valide<br>";
            error++;
        } else {
        ...
        if (!isNaN(firstname.value)) {
            ...
            feedback.innerHTML += "Veuillez entrer un prénom valide<br>";
            error++;
        } else {
        ...
        if (!isNaN(familyName.value)) {
            ...
            feedback.innerHTML += "Veuillez entrer un nom valide<br>";
            error++;
        } else {
            familyName.classList.add('valid');
            familyName.classList.remove('valid');
        }
        if (!(mdp.value)) {
