...
if (isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['cp']) && isset($_POST['ville']) && isset($_POST['adresse']) && isset($_POST['reglement'])) {
    ...
    // On vérifie si la personne a déjà participé au cours de la journée
    if ($email == $limit['email']) {
        ...
        $message = '<html><body><h1>' . $objet . '</h1>'//Corps du mail
                ...
                . '</div> son num�ro de t�l�phone est le ' . $expediteurtel . '</body></html>';
        ...
        <div class="col-md-8">
            <div class="boxed-grey">
                <form id="registration-form" method="post" action="inscription.php">
                    ...
                    <h6>Tous les champs marqu�s d'une * sont obligatoires</h6>
                    <div class="row">
                        <div class="col-md-6 ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="prenom" id="prenom" maxlength="48" placeholder="Entrer pr�nom" required="required" />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" name="tel" id="tel" maxlength="10" placeholder="Entrer t�l�phone" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label class="form-check-label">
                                    ...
                                    J'accepte <a href="reglement.php" target="_blank"> le r�glement du jeu</a> *
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6"> 
