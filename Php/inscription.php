                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input value="<?php echo(isset($_POST['cp']) ? $_POST['cp'] : ''); ?>" type="text"
                                           class="form-control" name="cp" id="cp" maxlength="5" format="NNNNN"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input value="<?php echo(isset($_POST['ville']) ? $_POST['ville'] : ''); ?>"
                                           ...
                                           format="MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="<?php echo(isset($_POST['tel']) ? $_POST['tel'] : ''); ?>" type="tel"
                                           class="form-control" name="tel" id="tel" maxlength="10" format="NNNNNNNNNN"
